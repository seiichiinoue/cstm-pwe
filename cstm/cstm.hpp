...
namespace cstm {
    ...
    public:
        ...
        double **_semantic_vectors;     // 意味ベクトル; use pretrained embeddings
        ...
        double compute_alpha_word_given_doc(id word_id, int doc_id) {
            ...
            return _compute_alpha_word(semantic_vec, doc_vec_in_semantic_space, g0);
        }
        ...
        double _compute_alpha_word(double *semantic_vec, double *doc_vec_in_semantic_space, double g0) {
            assert(g0 > 0);
